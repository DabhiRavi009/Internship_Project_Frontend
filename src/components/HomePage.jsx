...
import I2 from "./assest/Images/about-img.jpg";
import I3 from "./assest/Images/professional-img.png";
  ...
  const cards = [
    {
      img: I4,
      header: "Maintenance",
      para: "At our local service, we specialize in property maintenance to ensure your home or business runs smoothly. With expertinspections and proactive repairs.",
    },
    {
      img: I5,
      header: "Electrical",
      para: "Our local service specializes in expert electrical solutions for homes and businesses. From installations to repairs and maintenance, our skilled electricians ensure safety, reliability, and efficiency.",
    },
    {
      img: I6,
      header: "Plumbing",
      para: "In our local service, we excel in providing top-notch plumbing solutions for both residential and commercial needs. With a team of experienced plumbers, we offer a range of services including repairs, installations, and maintenance.",
    },
  ];
            ...
            <div className="row">
              <div className="col-md-6 ">
                <div className="detail-box">
                  ...
                  <p>
                    Welcome to Local Service .At Local Service, we bring
                    convenience and expertise to your doorstep. Say goodbye to
                    the hassle of finding reliable service providers. Whether
                    you need a plumber, electrician, cleaner, or beautician. we
                    have got you covered. Our platform connects you with skilled
          ...
          <div className="row">
            <div className="col-lg-5 col-md-6">
              <div className="detail-box">
                <h2>About us</h2>
                <p>
                  Located in the heart of our community, our local service is
                  dedicated to providing essential assistance and support to
                  residents and businesses alike. With a team of passionate
                  individuals committed to making a positive impact, we offer a
                  wide range of services tailored to meet the diverse needs of
                  our neighbors. Whether it is delivering meals to the elderly,
                  organizing neighborhood clean-up events, or providing
          ...
          <div className="row">
            ...
            <div className="col-md-6 ">
              <div className="detail-box">
                ...
                <p>
                  we take pride in offering professional home services designed
                  to elevate the comfort and convenience of our clients living
                  spaces. With a team of highly skilled technicians and
                  specialists, we deliver top-notch expertise in a variety of
                  areas, including plumbing, electrical work, HVAC maintenance,
                  and general home repairs. Whether it is fixing a leaky faucet,
                  installing new lighting fixtures, or conducting routine
                  maintenance on heating and cooling systems, our goal is to
